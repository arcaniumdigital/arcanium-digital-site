      ...
      <div className="relative mx-auto max-w-[1280px]">
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-5">
            ...
            <p className="mt-4 max-w-[650px] text-base font-medium leading-[1.65] text-[#aaaab2] lg:text-lg">That’s Generative Engine Optimisation (GEO). We influence the signals Google and AI algorithms rely on, strengthening your website, content, profiles and authority so your name is pushed toward the top when vendors search for an agent.</p>
          </div>
        ...
        <div className="mt-20 border-t border-white/9 lg:mt-32">
          {["YOU GET FOUND FIRST.", "YOU GET CONSIDERED FIRST.", "YOU GET THE OPPORTUNITY FIRST."].map((line) => (
