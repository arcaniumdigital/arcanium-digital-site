...
test("recovered Make payload remains field-compatible", () => {
  assert.deepEqual(buildMakeWebhookPayload({ fullName: "Example Lead", phone: "+61400000000", bookingToken: "a".repeat(24), submittedAt: "2026-08-04T00:00:00.000Z" }), {
    fullName: "Example Lead", phone: "+61400000000", offer: "Vendor Conversion Audit", booking_token: "a".repeat(24), source_lead_id: "a".repeat(24), submittedAt: "2026-08-04T00:00:00.000Z",
  });
});
