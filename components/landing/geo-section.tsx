      ...
      <div className="relative mx-auto max-w-[1280px]">
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-5">
            <p className="flex items-center gap-2.5 text-xs font-semibold uppercase tracking-[0.14em] text-[#aaaab2]"><span className="size-1.5 rounded-full bg-[#8f33ff]" />Paid search and local visibility</p>
            <h2 className="mt-5 max-w-[690px] font-display text-[clamp(2.125rem,9.5vw,2.5rem)] font-semibold leading-[1] tracking-[-0.04em] lg:text-[clamp(3rem,4vw,4.25rem)]">Be Present When the Search Matters</h2>
            <p className="mt-5 max-w-[650px] text-base font-medium leading-[1.65] text-[#aaaab2] lg:mt-6 lg:text-lg">A vendor looking for an agent may search Google, compare local profiles or ask an AI tool for options. A useful campaign reaches the right searches and gives people a clear reason to contact you.</p>
            <p className="mt-4 max-w-[650px] text-base font-medium leading-[1.65] text-[#aaaab2] lg:text-lg">We connect Google Ads with your website, local proof and reporting so the journey from search to enquiry is easier to see and improve. Organic visibility and AI discoverability support the same goal over time.</p>
          </div>
        ...
        <div className="mt-20 border-t border-white/9 lg:mt-32">
          {["REACH RELEVANT SEARCHES.", "SHOW WHY VENDORS SHOULD TRUST YOU.", "MAKE THE NEXT STEP EASY."].map((line) => (
