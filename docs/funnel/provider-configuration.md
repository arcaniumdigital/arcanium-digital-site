...
- Reuse the existing reply-capable approved sender; do not provision a second number for this funnel.
...
- Keep all provider and production allow flags false until staged evidence is signed off.
