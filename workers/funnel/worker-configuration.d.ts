/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/funnel/wrangler.jsonc workers/funnel/worker-configuration.d.ts` (hash: 637c0006c6a914b6f4319cc099ba8316)
...
interface __BaseEnv_Env {
	...
	CLICKSEND_MINIMUM_BALANCE_AUD: "0" | "20";
...
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		ALLOW_WEEKLY_LIVE_SMS_CANARY: "false";
		CLICKSEND_MINIMUM_BALANCE_AUD: "0";
		CLICKSEND_MAX_PARTS_PREBOOK: "3";
		CLICKSEND_MAX_PARTS_BOOKED: "4";
		LOG_LEVEL: "info";
