  ...
  return (
    <section className="relative overflow-hidden bg-[#f3f2ee] px-3 py-16 text-white sm:px-4 lg:px-12 lg:py-32">
      <div className="surface-noise relative mx-auto flex min-h-[430px] max-w-[1280px] items-center overflow-hidden rounded-[22px] border border-black/10 bg-[#08090c] px-5 py-16 lg:min-h-[540px] lg:rounded-[32px] lg:px-12">
        ...
        <h2 className="font-display text-[clamp(2.375rem,10vw,2.75rem)] font-semibold leading-[0.98] tracking-[-0.045em] lg:text-[clamp(3.25rem,5vw,4.875rem)]">How Many Vendor Opportunities Are You Missing?</h2>
        <p className="mx-auto mt-6 max-w-[650px] text-base font-medium leading-[1.65] text-[#aaaab2] lg:text-lg">Get a Vendor Lead Opportunity Snapshot of the local searches, paid opportunities and online gaps worth reviewing before your next campaign.</p>
        <MetaTrackedLink href="#audit" trackingLabel="Get my vendor lead opportunity snapshot - final CTA" className="group mt-8 inline-flex min-h-[58px] w-full items-center justify-center rounded-[14px] border border-white/15 bg-[#f4f4f2] px-8 text-sm font-semibold text-[#0b0c0f] transition-all duration-300 hover:-translate-y-px hover:bg-white sm:w-auto">
