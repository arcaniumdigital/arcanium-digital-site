/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/funnel/wrangler.jsonc workers/funnel/worker-configuration.d.ts` (hash: c53bff11e54ecf2ebfce7b3eb8e18d8d)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://arcaniumdigital.com,https://www.arcaniumdigital.com" | "http://localhost:3000,https://arcaniumdigital.com,https://www.arcaniumdigital.com";
	EXPECTED_TURNSTILE_HOSTNAMES: "arcaniumdigital.com,www.arcaniumdigital.com" | "localhost,127.0.0.1";
	EXPECTED_TURNSTILE_ACTION: "vendor_audit";
	BOOKING_CONTEXT_SESSION_TTL_SECONDS: "1800";
	BOOKING_CONTEXT_COOKIE_DOMAIN: "arcaniumdigital.com" | "";
	BOOKING_LINK_BASE_URL: "https://arcaniumdigital.com/audit";
	CAL_API_VERSION: "2024-06-14";
	CAL_EVENT_TYPE_ID: "6136671" | "6601494";
	CAL_EXPECTED_EVENT_SLUG: "magnet" | "vendor-conversion-audit";
	CAL_EXPECTED_WEBHOOK_URL: "https://arcanium-funnel-prod.enquiries-432.workers.dev/webhooks/cal/bookings" | "https://arcanium-funnel-staging.enquiries-432.workers.dev/webhooks/cal/bookings";
	BROCHURE_URL: "https://arcaniumdigital.com";
	BUSINESS_NAME: "Arcanium Digital";
	BUSINESS_TIMEZONE: "Australia/Brisbane";
	SMS_ALLOWED_START_HOUR: "7";
	SMS_ALLOWED_END_HOUR: "20";
	CLICKSEND_SMS_ENABLED: "true" | "false";
	CLICKSEND_TWO_WAY_ENABLED: "false";
	CLICKSEND_MANUAL_REPLY_HANDLING_APPROVED: "true" | "false";
	CLICKSEND_URL_MESSAGING_APPROVED: "true" | "false";
	ALLOW_PRODUCTION_SMS: "true" | "false";
	ALLOW_PREBOOK_NURTURE: "true" | "false";
	ALLOW_BOOKING_REMINDERS: "true" | "false";
	ALLOW_WEEKLY_LIVE_SMS_CANARY: "false";
	CLICKSEND_MINIMUM_BALANCE_AUD: "5" | "20";
	CLICKSEND_MAX_PARTS_PREBOOK: "3";
	CLICKSEND_MAX_PARTS_BOOKED: "4";
	LOG_LEVEL: "info";
	DEPLOYMENT_VERSION: "set-by-ci" | "local";
	SCHEMA_VERSION: "2";
	STALE_JOB_THRESHOLD_MINUTES: "15";
	TURNSTILE_SECRET_KEY: string;
	INTERNAL_API_HMAC_SECRET: string;
	BOOKING_CONTEXT_HMAC_SECRET: string;
	CAL_WEBHOOK_SECRET: string;
	CAL_API_KEY: string;
	CLICKSEND_USERNAME: string;
	CLICKSEND_API_KEY: string;
	CLICKSEND_FROM_NUMBER: string;
	CLICKSEND_INBOUND_WEBHOOK_TOKEN: string;
	CLICKSEND_RECEIPT_WEBHOOK_TOKEN: string;
	CLICKSEND_OWNER_ALERT_NUMBER: string;
	BREVO_API_KEY: string;
	BREVO_PIPELINE_ID: string;
	BREVO_STAGE_NEW_ENQUIRY_ID: string;
	BREVO_STAGE_BOOKED_ID: string;
	BREVO_STAGE_CANCELLED_ID: string;
	BREVO_STAGE_COMPLETED_ID: string;
	BREVO_TEMPLATE_NEW_LEAD_ID: string;
	BREVO_TEMPLATE_BOOKING_CREATED_ID: string;
	BREVO_TEMPLATE_BOOKING_CANCELLED_ID: string;
	BREVO_TEMPLATE_REPLY_ALERT_ID: string;
	BREVO_TEMPLATE_INCIDENT_ID: string;
	BREVO_TEMPLATE_DAILY_DIGEST_ID: string;
	BREVO_SENDER_EMAIL: string;
	BREVO_SENDER_NAME: string;
	BREVO_OPERATOR_EMAIL: string;
	OPERATOR_NAME: string;
	INNGEST_EVENT_KEY: string;
	FUNNEL_HEALTH_READ_TOKEN: string;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_ORIGINS: "https://arcaniumdigital.com,https://www.arcaniumdigital.com";
		EXPECTED_TURNSTILE_HOSTNAMES: "arcaniumdigital.com,www.arcaniumdigital.com";
		EXPECTED_TURNSTILE_ACTION: "vendor_audit";
		BOOKING_CONTEXT_SESSION_TTL_SECONDS: "1800";
		BOOKING_CONTEXT_COOKIE_DOMAIN: "arcaniumdigital.com";
		BOOKING_LINK_BASE_URL: "https://arcaniumdigital.com/audit";
		CAL_API_VERSION: "2024-06-14";
		CAL_EVENT_TYPE_ID: "6136671";
		CAL_EXPECTED_EVENT_SLUG: "magnet";
		CAL_EXPECTED_WEBHOOK_URL: "https://arcanium-funnel-prod.enquiries-432.workers.dev/webhooks/cal/bookings";
		BROCHURE_URL: "https://arcaniumdigital.com";
		BUSINESS_NAME: "Arcanium Digital";
		BUSINESS_TIMEZONE: "Australia/Brisbane";
		SMS_ALLOWED_START_HOUR: "7";
		SMS_ALLOWED_END_HOUR: "20";
		CLICKSEND_SMS_ENABLED: "true";
		CLICKSEND_TWO_WAY_ENABLED: "false";
		CLICKSEND_MANUAL_REPLY_HANDLING_APPROVED: "true";
		CLICKSEND_URL_MESSAGING_APPROVED: "true";
		ALLOW_PRODUCTION_SMS: "true";
		ALLOW_PREBOOK_NURTURE: "true";
		ALLOW_BOOKING_REMINDERS: "true";
		ALLOW_WEEKLY_LIVE_SMS_CANARY: "false";
		CLICKSEND_MINIMUM_BALANCE_AUD: "5";
		CLICKSEND_MAX_PARTS_PREBOOK: "3";
		CLICKSEND_MAX_PARTS_BOOKED: "4";
		LOG_LEVEL: "info";
		DEPLOYMENT_VERSION: "set-by-ci";
		SCHEMA_VERSION: "2";
		STALE_JOB_THRESHOLD_MINUTES: "15";
		TURNSTILE_SECRET_KEY: string;
		INTERNAL_API_HMAC_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "EXPECTED_TURNSTILE_HOSTNAMES" | "EXPECTED_TURNSTILE_ACTION" | "BOOKING_CONTEXT_SESSION_TTL_SECONDS" | "BOOKING_CONTEXT_COOKIE_DOMAIN" | "BOOKING_LINK_BASE_URL" | "CAL_API_VERSION" | "CAL_EVENT_TYPE_ID" | "CAL_EXPECTED_EVENT_SLUG" | "CAL_EXPECTED_WEBHOOK_URL" | "BROCHURE_URL" | "BUSINESS_NAME" | "BUSINESS_TIMEZONE" | "SMS_ALLOWED_START_HOUR" | "SMS_ALLOWED_END_HOUR" | "CLICKSEND_SMS_ENABLED" | "CLICKSEND_TWO_WAY_ENABLED" | "CLICKSEND_MANUAL_REPLY_HANDLING_APPROVED" | "CLICKSEND_URL_MESSAGING_APPROVED" | "ALLOW_PRODUCTION_SMS" | "ALLOW_PREBOOK_NURTURE" | "ALLOW_BOOKING_REMINDERS" | "ALLOW_WEEKLY_LIVE_SMS_CANARY" | "CLICKSEND_MINIMUM_BALANCE_AUD" | "CLICKSEND_MAX_PARTS_PREBOOK" | "CLICKSEND_MAX_PARTS_BOOKED" | "LOG_LEVEL" | "DEPLOYMENT_VERSION" | "SCHEMA_VERSION" | "STALE_JOB_THRESHOLD_MINUTES" | "TURNSTILE_SECRET_KEY" | "INTERNAL_API_HMAC_SECRET" | "BOOKING_CONTEXT_HMAC_SECRET" | "CAL_WEBHOOK_SECRET" | "CAL_API_KEY" | "CLICKSEND_USERNAME" | "CLICKSEND_API_KEY" | "CLICKSEND_FROM_NUMBER" | "CLICKSEND_INBOUND_WEBHOOK_TOKEN" | "CLICKSEND_RECEIPT_WEBHOOK_TOKEN" | "CLICKSEND_OWNER_ALERT_NUMBER" | "BREVO_API_KEY" | "BREVO_PIPELINE_ID" | "BREVO_STAGE_NEW_ENQUIRY_ID" | "BREVO_STAGE_BOOKED_ID" | "BREVO_STAGE_CANCELLED_ID" | "BREVO_STAGE_COMPLETED_ID" | "BREVO_TEMPLATE_NEW_LEAD_ID" | "BREVO_TEMPLATE_BOOKING_CREATED_ID" | "BREVO_TEMPLATE_BOOKING_CANCELLED_ID" | "BREVO_TEMPLATE_REPLY_ALERT_ID" | "BREVO_TEMPLATE_INCIDENT_ID" | "BREVO_TEMPLATE_DAILY_DIGEST_ID" | "BREVO_SENDER_EMAIL" | "BREVO_SENDER_NAME" | "BREVO_OPERATOR_EMAIL" | "OPERATOR_NAME" | "INNGEST_EVENT_KEY" | "FUNNEL_HEALTH_READ_TOKEN">> {}
}
