    ...
    <section className="relative flex min-h-[100svh] flex-col items-start justify-center overflow-hidden bg-black">
      <div className="absolute inset-0 z-0">
        <video
          ...
          playsInline
          aria-hidden="true"
          className="h-full w-full translate-x-[14%] -translate-y-[8%] scale-[0.86] object-contain object-center opacity-70 md:translate-x-0 md:translate-y-0 md:scale-100 md:object-cover md:object-center"
        >
